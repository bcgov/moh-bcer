...
export class DoingBusinessAs1608236921062 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "salesreport" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "containers" character varying NOT NULL, "cartridges" character varying NOT NULL, "year" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "productId" uuid, "locationId" uuid, CONSTRAINT "PK_d11db0bce115356912b23b45009" PRIMARY KEY ("id"))`);
