...
export class UpdateNoiExpiryWithDecember1670359794448 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`
            ...
            BEGIN	
                if (inputDateMonth IN (10, 11, 12) OR (inputDateMonth = 1 AND inputDateDay <= 15)) THEN
