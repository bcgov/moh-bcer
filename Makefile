...
export KEYCLOAK_REALM := $(or $(KEYCLOAK_REALM),bcer)
export KEYCLOAK_AUTH_URL := $(or $(KEYCLOAK_AUTH_URL),https://common-logon-test.hlth.gov.bc.ca/auth/)
export KEYCLOAK_CLIENT := $(or $(KEYCLOAK_CLIENT),BCER)
...
export KEYCLOAK_DATA_AUTH_URL := $(or $(KEYCLOAK_DATA_AUTH_URL),https://common-logon-test.hlth.gov.bc.ca/auth/)

# Test Env
export TEST_KEYCLOAK_PORT := $(or $(TEST_KEYCLOAK_PORT),8080)
export TEST_KEYCLOAK_REALM := $(or $(TEST_KEYCLOAK_REALM),bcer)
export TEST_KEYCLOAK_AUTH_URL := $(or $(TEST_KEYCLOAK_AUTH_URL),https://common-logon-test.hlth.gov.bc.ca/auth/)
export TEST_KEYCLOAK_CLIENT := $(or $(TEST_KEYCLOAK_CLIENT),BCER)
export TEST_KEYCLOAK_DATA_REALM := $(or $(TEST_KEYCLOAK_DATA_REALM),moh_applications)
export TEST_KEYCLOAK_DATA_CLIENT := $(or $(TEST_KEYCLOAK_DATA_CLIENT),BCER-CP)
export TEST_KEYCLOAK_DATA_AUTH_URL := $(or $(TEST_KEYCLOAK_DATA_AUTH_URL),https://common-logon-test.hlth.gov.bc.ca/auth/)
